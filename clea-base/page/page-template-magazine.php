	...
	<div id="content" class="hfeed">
				...
				<?php while ( $loop->have_posts() ) : $loop->the_post(); $do_not_duplicate[] = get_the_ID();  ?>
					...
					<article id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
							...
							<header class="entry-header">
								...
								<?php echo apply_atomic_shortcode( 'entry_byline', '<div class="entry-byline">' . __( 'Published on [entry-published] [entry-edit-link before=" | "]', 'clea-base' ) . '</div>' ); ?>
							</header><!-- .entry-header -->
		...
		<?php if ( $loop->have_posts() ) : ?>
			...
			<div class="gallery">
				...
				<h2 class="gallery-title">
					<?php _e( 'Latest Images', 'clea-base' ); ?>
					<a class="post-format-link" href="<?php echo get_post_format_link( 'image' ); ?>"><?php _e( 'View Archive &rarr;', 'clea-base' ); ?></a>
				</h2>
		...
		<?php if ( $loop->have_posts() ) : ?>
			...
			<div class="gallery">
				...
				<h2 class="gallery-title">
					<?php _e( 'Latest Galleries', 'clea-base' ); ?>
					<a class="post-format-link" href="<?php echo get_post_format_link( 'gallery' ); ?>"><?php _e( 'View Archive &rarr;', 'clea-base' ); ?></a>
				</h2>
