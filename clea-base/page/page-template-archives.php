				...
				<article id="post-<?php the_ID(); ?>" class="<?php hybrid_entry_class(); ?>">
					...
					<div class="entry-content">
						...
						<?php else : ?>
							...
							<h2><?php _e( 'Archives by category', 'clea-base' ); ?></h2>

							<ul class="xoxo category-archives">
								<?php wp_list_categories( array( 'feed' => __( 'RSS', 'clea-base' ), 'show_count' => true, 'use_desc_for_title' => false, 'title_li' => false ) ); ?>
							</ul><!-- .xoxo .category-archives -->

							<h2><?php _e( 'Archives by month', 'clea-base' ); ?></h2>
