			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<article <?php hybrid_post_attributes(); ?>>
					...
					<header class="entry-header">
						...
						<?php echo apply_atomic_shortcode( 'entry_byline', '<div class="entry-byline">' . sprintf( __( 'Sizes: %s', 'clea-base' ), unique_get_image_size_links() ) . '</div>' ); ?>
					</header><!-- .entry-header -->
					...
					<div class="entry-content">
						...
						<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'clea-base' ) ); ?>
				...
				<div class="attachment-meta">
					...
					<?php if ( !empty( $gallery ) ) { ?>
						<div class="image-gallery">
							<h3><?php _e( 'Gallery', 'clea-base' ); ?></h3>
							<?php echo $gallery; ?>
						</div>
					<?php } ?>
