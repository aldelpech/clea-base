...
class Unique_Widget_Most_Commented extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			...
			'description' => __( 'Display top commented posts.', 'clea-base' )
		);
		...
		/* Create the widget. */
		$this->WP_Widget( 'most-commented', __( 'Most Commented', 'clea-base' ), $widget_options, $control_options );
	}
	...
	function widget( $args, $instance ) {
		...
		if ( $loop->have_posts() ) {
			...
			while ( $loop->have_posts() ) {
				...
				comments_number( __( '(0)', 'clea-base' ), __( '(1)', 'clea-base' ), __( '(%)', 'clea-base' ), 'comments-link', '' );
				echo '<span>';
				echo '</li>';
			}
	...
	function form( $instance ) {
		...
		/* Set up the defaults. */
		$defaults = array(
			'title' => __( 'Most Commented', 'clea-base' ),
			'post_type' => 'post',
			'posts_per_page' => 10,
			'year' => '',
			'monthnum' => '',
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'post_type' ); ?>"><?php _e( 'Post Type:', 'clea-base' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'posts_per_page' ); ?>"><?php _e( 'Limit:', 'clea-base' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'year' ); ?>"><?php _e( 'Year:', 'clea-base' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'monthnum' ); ?>"><?php _e( 'Month:', 'clea-base' ); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'day' ); ?>"><?php _e( 'Day:', 'clea-base' ); ?></label> 
