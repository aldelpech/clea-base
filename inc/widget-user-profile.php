...
class Unique_Widget_User_Profile extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			...
			'description' => __( "Display a user's profile.", 'clea-base' )
		);
		...
		/* Create the widget. */
		$this->WP_Widget( 'user-profile', esc_attr__( 'User Profile', 'clea-base' ), $widget_options, $control_options );
	}
	...
	function widget( $args, $instance ) {
		...
		$more = '<a class="user-profile-more" href="' . $more_url . '" title="' . esc_attr( get_the_author_meta( 'display_name', $user_id ) ) . '">' . __( 'Read more &rarr;', 'clea-base' ) . '</a>';
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'clea-base' ); ?></label>
			<input type="text" class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" />
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'user' ); ?>"><?php _e( 'User:', 'clea-base' ); ?></label> 
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'avatar_size' ); ?>"><?php _e( 'Avatar Size:', 'clea-base' ); ?></label>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'avatar_align' ); ?>"><?php _e( 'Avatar Alignment:', 'clea-base' ); ?></label> 
			<select style="float:right;max-width:66px;" class="widefat" id="<?php echo $this->get_field_id( 'avatar_align' ); ?>" name="<?php echo $this->get_field_name( 'avatar_align' ); ?>">
				<?php foreach ( array( 'alignnone' => __( 'None', 'clea-base'), 'alignleft' => __( 'Left', 'clea-base' ), 'alignright' => __( 'Right', 'clea-base' ), 'aligncenter' => __( 'Center', 'clea-base' ) ) as $option_value => $option_label ) { ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'custom_user_text' ); ?>"><?php _e( 'Custom Text:', 'clea-base' ); ?></label>
			...
			<?php _e( 'User bio will be used if left empty.', 'clea-base' ); ?>
		</p>

		<p>
			<label for="<?php echo $this->get_field_id( 'custom_user_page' ); ?>"><?php _e( '"Read More" should link to:', 'clea-base' ); ?></label> 
			...
			<?php $select = wp_dropdown_pages(
				array(
					...
					'show_option_none' => __( 'Author Archive Page', 'clea-base' ),
					'echo' => false
				)
			);
